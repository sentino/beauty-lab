  ...
  template: `
    <div class="l-consultation">
      <div class="c-question">
        ...
        <p class="c-question__text box-href" [innerHTML]="question.QUESTION | sanitizeHtml" [href]></p>
        <div class="c-answer" *ngIf="question.SPECIALIST.NAME">
          ...
          <div class="l-answer__info">
            ...
            <p class="c-answer__text box-href" [innerHTML]="question.ANSWER | sanitizeHtml" [href]></p>
          </div>
        </div>
      </div>
    </div>
